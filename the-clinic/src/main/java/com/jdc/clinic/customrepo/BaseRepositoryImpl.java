package com.jdc.clinic.customrepo;
...
public class BaseRepositoryImpl<T, ID> extends SimpleJpaRepository<T, ID> implements BaseRepository<T, ID>{
	...
	public List<T> find(String jpql, Map<String, Object> params) {
		TypedQuery<T> query = em.createQuery(jpql, entityInfo.getJavaType());
		this.setParams(query, params);
		return query.getResultList();
	}

	@Override
	public long findCount(String jpql, Map<String, Object> params) {
